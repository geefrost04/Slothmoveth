...
export function Navbar({ backHref, backLabel = 'กลับหน้าหลัก' }: NavbarProps = {}) {
  ...
  const themeLabel = isDark ? 'สลับเป็นโหมดสว่าง' : 'สลับเป็นโหมดมืด';
      ...
      <header className={`nav-wrapper${scrolled ? ' scrolled' : ''}`} id="navbar">
        <div className="container">
          <nav className="nav-inner" aria-label="เมนูหลัก">
            <Link href="/" className="nav-logo" aria-label="SlothMove">
              <img src="/pic/slothmove_mascot.png" alt="SlothMove" width={40} height={40} style={{ objectFit: 'contain' }} />
            ...
            <div className="nav-links">
              ...
              <Link href="/courses" className="nav-link">คอร์สทั้งหมด</Link>
              <Link href="/rat-ngan" className="nav-link">ข่าวสาร</Link>
        ...
        >
          <div className="mobile-menu-inner">
            ...
            <Link href="/courses" onClick={closeMenu}>คอร์สทั้งหมด</Link>
            <Link href="/rat-ngan" onClick={closeMenu}>ข่าวสาร</Link>
            ...
            <button
              type="button"
              className={`mobile-theme-toggle${theme === 'dark' ? ' is-dark' : ''}`}
              onClick={() => {
                toggle();
                closeMenu();
              }}
